...
export const TestimonialCarousel = () => {
  return (
    <div className="relative box-border caret-transparent shrink-0 h-[350px] w-full">
      <section className="items-center box-border caret-transparent flex h-full justify-items-center list-none max-h-full max-w-full w-full overflow-hidden">
        <ul className="relative items-center box-border caret-transparent gap-x-5 flex h-full justify-items-center left-[-3720px] max-h-full max-w-full gap-y-5 w-full pl-0">
          <li className="box-border caret-transparent h-[342px] w-[352px]">
            <div className="relative box-border caret-transparent shrink-0 h-[342px] w-[352px]">
              <TestimonialCard
                ...
                authorName="Carter June"
                companyLogoUrl="https://framerusercontent.com/images/7gBs4Qym6w5w5VToXqPFZUirIg.svg?width=99&height=19"
              />
            </div>
          </li>
          <li className="box-border caret-transparent h-[342px] w-[352px]">
