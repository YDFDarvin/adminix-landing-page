...
export const PricingCards = () => {
  return (
    <div className="relative content-end items-stretch box-border caret-transparent gap-x-5 flex flex-col shrink-0 justify-center gap-y-5 w-full md:gap-y-0 lg:flex-row lg:items-stretch">
      <div className="relative box-border caret-transparent basis-auto grow-0 shrink-0 w-full lg:basis-0 lg:grow lg:w-px h-full flex">
        <div className="relative content-center items-center bg-white shadow-[rgba(0,0,0,0.03)_0px_1px_20px_0px] box-border caret-transparent gap-x-6 flex flex-col h-full justify-center gap-y-6 w-full overflow-hidden rounded-[20px] min-h-[720px]">
          <PricingCard
            planName="Starter"
            price="$45"
      ...
      <div className="relative box-border caret-transparent basis-0 grow shrink-0 w-px h-full flex">
        <div className="relative content-center items-center bg-white shadow-[rgba(0,0,0,0.03)_0px_1px_20px_0px] box-border caret-transparent gap-x-6 flex flex-col h-full justify-center gap-y-6 w-full overflow-hidden rounded-[20px]">
          <PricingCard
            planName="Pro"
            price="$599"
